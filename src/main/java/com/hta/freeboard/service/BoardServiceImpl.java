...
import mybatis.freeBoardManager;
...
public class BoardServiceImpl implements BoardService {
	...
	public List getList(){//리스트 전체 보기 기능
		...
		*/
		...
		return freeBoardManager.getList();//mybatis를 이용하면 이한줄이면 끝난다. 즉, BoardManager.java 클래스의 메서드를 가져온것이다.
	}
	/*
	...
	public BoardDto findBySeq(int seq){//읽기 기능
		...
		return dto;*/
		return new freeBoardManager().finBySeq(seq);
	}
	...
	public void write(BoardDto dto){//쓰기기능
		...
		freeBoardManager.write(dto);//mybatis로 사용
	...
	public void delete(int seq){
		...
		JdbcTemplate.update(sql, values);*/
		freeBoardManager.delete(seq);

	}
	public void Reply(BoardDto dto) {
		
		freeBoardManager.Reply(dto);
		
	}
	public void posupdate(BoardDto dto) {
		// TODO Auto-generated method stub
		freeBoardManager.PosUpdate(dto);
	}
	public void posupdateall(BoardDto dto) {
		// TODO Auto-generated method stub
		freeBoardManager.PosUpdateAll(dto);
	}
	public void increaseCount(BoardDto dto) {
		// TODO Auto-generated method stub
		System.out.println("2. 카운터증가 실행되니??");
		freeBoardManager.IncreaseCount(dto);
	}

	public List findKeyword(BoardDto dto) {
		// TODO Auto-generated method stub
		return freeBoardManager.findKeyword(dto);
	}
