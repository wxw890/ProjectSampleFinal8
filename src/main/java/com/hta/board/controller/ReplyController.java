...
private BoardService boardService;
	...
	@RequestMapping("/reply.board")
	public ModelAndView ReplyPageMove(@RequestParam int b_seq, HttpSession session){
	...
	public String ReplyWriter(@ModelAttribute BoardDto rdto, HttpSession session){//rdto는 답글 dto이다. 하지만 여기에 부모글에 대한 b_num도 가지고있다.
		...
		rdto.setB_writer(session_email);
